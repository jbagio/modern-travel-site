...
var RevealOnScroll = function () {
  ...
  _createClass(RevealOnScroll, [{
    ...
    value: function createWaypoints() {
      var self = this;
      this.itemsToReveal.each(function (index, elem) {
        new Waypoint({
          element: elem,
          handler: function handler() {
            (0, _jquery2.default)(elem).addClass('reveal-item--is-visible');
          },
          offset: self.offset
        });
      });
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          if (direction == 'down') {
            (0, _jquery2.default)(self.siteHeader).addClass('site-header--dark');
          } else {
            (0, _jquery2.default)(self.siteHeader).removeClass('site-header--dark');
    ...
    value: function createPageSectionWaypoints() {
      var self = this;
      this.pageSections.each(function (index, elem) {
        new Waypoint({
          element: elem,
          handler: function handler(direction) {
            if (direction == 'down') {
              var matchingLink = elem.getAttribute('data-matching-link');
              self.headerLinks.removeClass('is-current-link');
